            ...
            <div className="container">
                <div className="footer-grid">
                    ...
                    <div className="footer-brand">
                        <a href="/" style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
                ...
                <div className="footer-bottom">
                    <p>&copy; {new Date().getFullYear()} Foodify. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>
    );
