                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                    <div>
                        ...
                        <p style={{ fontSize: '0.85rem', color: '#9ca3af' }}>
                            Número conectado al agente Foodfy
                        </p>
                    </div>
                    <span style={{
            ...
            <div className="card-3d" style={{ ...glassCard, padding: '1.5rem', marginBottom: '1rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                    <div>
                        ...
                        <p style={{ fontSize: '0.85rem', color: '#9ca3af' }}>
                            {isActive ? 'Tu agente está activo y recibiendo llamadas' : 'Tu agente está pausado'}
                        </p>
                    </div>
    ...
    return (
        <div className="page-animate">
            <div style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ color: '#9ca3af', fontSize: '0.95rem', letterSpacing: '-0.01em' }}>
                    Gestiona la configuración de tu agente y tu negocio
                </p>
            </div>
